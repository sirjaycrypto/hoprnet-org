...
export default function Index() {
  return (
    <Layout>
      <HeroInternal>
        <div>
          <h1>Independent, Incorruptible, And Indestructible</h1>
        </div>
        <div>
          <p>
          ...
          <p>
            With the HOPR protocol, data security is solved, letting everyone
            focus on helping people through digitalization.
          </p>
          <p>
